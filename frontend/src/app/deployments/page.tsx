          ...
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-700">
                A list of all Kubernetes deployments across your clusters.
              </p>
            </div>
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {deployments.map((deployment) => (
                        <tr key={deployment.id}>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{deployment.cluster}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{deployment.namespace}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            <span className="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">
                              {deployment.status}
                            </span>
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{deployment.replicas}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{deployment.image}</td>
