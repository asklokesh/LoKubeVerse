...
export default function ClustersPage() {
  const { clusters, loading, error, createCluster, updateCluster, deleteCluster } = useClusters();
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {clusters.map((cluster) => (
                        <tr key={cluster.id}>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{cluster.nodes}</td>
