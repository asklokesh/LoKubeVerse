...
export const MockDataProvider: React.FC<MockDataProviderProps> = ({
    ...
    useEffect(() => {
        // Setup axios mock interceptors for both axios and our api instance
        const mockInterceptor = axios.interceptors.request.use((config: any) => {
        ...
        // Add mock interceptor to our api instance
        const apiInterceptor = api.interceptors.request.use((config: any) => {
          return config;
        });
